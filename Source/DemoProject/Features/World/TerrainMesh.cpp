...
bool ATerrainMesh::BuildFromTerrainData(
    const FMapTerrainData &TerrainData,
  ...
  const float HalfSize = FMapTerrainData::TerrainWorldSize * 0.5f;
  const float Step =
      FMapTerrainData::TerrainWorldSize / static_cast<float>(GridSize - 1);
