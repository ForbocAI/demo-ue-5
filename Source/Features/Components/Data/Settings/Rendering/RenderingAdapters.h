 ...
 * @signature FProfileSettings ReadRenderingProfileSettings(const TSharedPtr<FJsonObject> &Object)
 *
 ...
 * @signature FSpecSettings ReadRenderingTextureSpecSettings(const TSharedPtr<FJsonObject> &Object)
 *
 ...
 * @signature TArray<FSpecSettings> ReadTextureCatalogSettings(const TSharedPtr<FJsonObject> &Object)
 *
 ...
 * @signature FRenderingSettings ReadRenderingSettings(const FSettingsRequest &Request)
 *
 ...
 * @signature FLodSettings ReadRenderingDistanceLodSettings(const TSharedPtr<FJsonObject> &Object)
 *
