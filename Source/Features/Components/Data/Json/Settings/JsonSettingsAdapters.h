...
// into typed settings structs. Owns the TField<T> fold machinery,
...
// TField<Settings> is an RTK entity adapter pattern: it owns the
...
// hand-writing per-field TField constructors.
