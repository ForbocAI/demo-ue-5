...
struct FRenderingRuntimeSettingsRequest {
 ...
 * @signature FRenderingRuntimeSettings ReadRenderingRuntimeSettings(const FRenderingRuntimeSettingsRequest &Request)
 *
