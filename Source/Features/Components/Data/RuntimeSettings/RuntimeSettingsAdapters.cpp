    ...
    static const TArray<TJsonSettingsField<FRuntimeStatsOverlaySettings>>
        RegisteredFields = {
            JSON_SETTING_FIELDS(
                ...
                StackDepthLabel, PolyCountLabel, UsedPhysicalMemoryLabel,
                PeakPhysicalMemoryLabel, UsedVirtualMemoryLabel,
                GameThreadMillisecondsLabel, RenderThreadMillisecondsLabel,
                ...
                AllWindowsHiddenLabel, LabelValueSeparator, ValueFormat,
                DecimalValueFormat, DebugMessageFormat,
            ...
            JSON_OBJECT_SETTING_FIELDS(
                ...
                ReadSettingsWith<FRuntimeStatsOverlaySettings>(
                    JSON_SETTINGS_ATOMS(
                        ...
                        LabelValueSeparator, ValueFormat, DecimalValueFormat,
