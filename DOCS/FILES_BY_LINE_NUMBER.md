...
| 687 | `Source/Features/Systems/Rendering/RenderingThunks.cpp` |
| 568 | `Source/Features/Systems/Speech/SpeechAdapters.h` |
| 482 | `Source/Features/Components/Data/RuntimeSettings/RuntimeSettingsAdapters.cpp` |
| 477 | `Source/Features/Components/ComponentsAdapters.h` |
| 455 | `Source/Tests/RuntimeStore.spec.cpp` |
| 425 | `Source/Features/Systems/Bots/Orchestrator/BotOrchestratorAdapters.cpp` |
| 423 | `Source/Views/RuntimeStatsWidget.cpp` |
...
| 328 | `Source/Features/Systems/Runtime/RuntimeSelectors.cpp` |
...
| 229 | `Source/Features/Components/Data/RuntimeSettings/RenderingSettingsTypes.h` |
| 228 | `Scripts/run-runtime-budget.sh` |
...
| 213 | `Source/Features/Systems/Terrain/TerrainReducers.cpp` |
| 207 | `Source/Features/Components/Data/RuntimeSettings/BotSettingsTypes.h` |
| 207 | `Source/Features/Components/Data/RuntimeSettings/UISettingsTypes.h` |
| 205 | `Source/Features/Systems/Bots/Pipeline/BotPipelineReducers.h` |
| 205 | `Source/Views/PlayerCharacterView.cpp` |
| 202 | `Source/Features/Components/Data/Json/JsonAdapters.cpp` |
| 201 | `Scripts/Tools/create_blueprint_assets.py` |
...
| 194 | `Source/Features/Components/Data/RuntimeSettings/RenderingSettingsAdapters.cpp` |
| 194 | `Source/Features/Systems/Bots/Townspeople/TownspersonTypes.h` |
| 193 | `Content/Data/runtime_settings_rendering_runtime_console_variables.json` |
| 193 | `README.md` |
| 188 | `Source/Features/Systems/Level/RuntimeLayout/LevelRuntimeLabelAdapters.cpp` |
| 181 | `Source/Core/frmt.hpp` |
| 180 | `Source/Views/TownspersonView.h` |
...
| 167 | `Source/Features/Components/Data/RuntimeSettings/LevelSettingsTypes.h` |
| 166 | `Source/Features/Components/Data/RuntimeSettings/RuntimeSettingsTypes.h` |
| 164 | `Source/Views/HorseView.cpp` |
...
| 148 | `Scripts/validate-runtime-budget.py` |
...
| 143 | `Content/Data/runtime_settings_ui.json` |
...
| 123 | `Source/Features/Systems/Runtime/RuntimeSelectors.h` |
| 122 | `Source/Features/Components/Rendering/RenderingTypes.h` |
...
| 90 | `Source/Features/Systems/Rendering/RenderingSlice.cpp` |
...
| 68 | `Source/Views/LevelGameModeView.cpp` |
...
| 56 | `Content/Data/runtime_settings_level.json` |
| 55 | `Source/Features/Systems/SystemsAdapters.cpp` |
| 55 | `Source/Views/RuntimeStatsWidget.h` |
...
| 53 | `Content/Data/runtime_performance_budget_ps3_baseline.json` |
...
| 50 | `Source/Views/TerrainMeshView.h` |
...
| 49 | `Source/Views/TerrainMeshView.cpp` |
...
| 45 | `Source/Views/LevelGameModeView.h` |
...
| 43 | `Source/Features/Systems/Rendering/RenderingThunks.h` |
...
| 41 | `Source/Features/Systems/Rendering/RenderingSlice.h` |
...
| 32 | `Content/Data/runtime_settings_rendering_profile.json` |
...
| 30 | `Source/Features/Systems/Terrain/TerrainReducers.h` |
...
| 27 | `Config/DefaultScalability.ini` |
...
| 11 | `Config/DefaultGameUserSettings.ini` |
